        ...
        <div class="">
            <div class="row">
                <div class="col-md-4 boder-right ">
                    <img src="{{ asset('assets/uploads/products/'.$products->image) }}" class="w-100" style="height: 300px;" alt="">
                </div>
                <div class="col-md-8">
                    <h2 class="mb-0">
                        {{ $products->name }}
                        <label style="font-size: 16px;" class="float-end badge bg-danger trending_tag">{{
                            $products->trending == '1' ? 'Trending': ''}}</label>
                    </h2>
                    <hr>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-9">
                            <br>
                            @if ($products->qty > 0)
                            <button class="btn btn-primary me-3 addToCartBtn float-start">Add to Cart <i
                                    class="fa-solid fa-cart-shopping"></i>
                            </button>
                            @endif

                            <button class="btn btn-success me-3 addToWishlist float-start">Add to Whishlist <i
