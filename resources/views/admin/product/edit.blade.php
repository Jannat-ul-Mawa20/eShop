        ...
        <form action="{{ url('update-product/'.$products->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="meta_description" rows="3" class="form-control">{{ $products->meta_discription }}</textarea>
                </div>
                @if ($products->image)
                <img src="{{ asset('assets/uploads/products/' .$products->image )}}" class="w-50" alt="">
                @endif
                <div class="col-md-12 mb-3">
